...
namespace Interfleet.XIUserManagement.Constants
{
    public static class QueryConstants
    {
        ...
        public const string UpdateUserQuery = @"Update tblUsers set UserName = @userName,Company=@company,Comments=@comments,InvalidLoginAttempts=@invalidLoginAttempts,UserAccountDisabled=@userAccountDisabled where UserId=@userId";
